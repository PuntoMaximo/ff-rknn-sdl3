...
int ffrknn::decode_and_display(AVCodecContext *dec_ctx, AVFrame *frame, AVPacket *pkt) {
    ...
    if (threadinit == 0) {
        // labelsListFile = (char*)"/usr/share/model/coco_2_labels_list_original.txt";
        labelsListFile = (char*)"/usr/share/model/coco_2_labels_list_placas.txt";

        if (!default_Settings) {
            if (selectLanguage())
                labelsListFile = (char*)"/usr/share/model/coco_2_labels_list_original.txt";
            else
                labelsListFile = (char*)"/usr/share/model/coco_2_labels_list.txt";
        }
...
void ffrknn::initYOLOV5() {
    ...
    // model_name = (char*)"/usr/share/model/yolov5n.rknn";
    model_name = (char*)"/usr/share/model/car-license-yolov5n.rknn";

    if (!default_Settings) {
        if (selectModel())
            model_name = (char*)"/usr/share/model/yolov5n.rknn";
        else
            model_name = (char*)"/usr/share/model/yolov5s_relu.rknn";
...
void initPPOCR() {
    ...
    model_name = (char*)"/usr/share/model/ppocrv4_rec.rknn";
    if (!model_name) {
        fprintf(stderr, "No model to load! Please pass a model.\n");
        return;
    }
